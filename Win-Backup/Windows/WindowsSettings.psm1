function Set-PreInstalltionSetting () {
    Get-NetAdapter Ethernet | Disable-NetAdapter -Confirm:$false
    # see comments @below
    # prevent drive installtion
    # should be included in registry_disableddrivers.pol
}

class InstalltionConfiguration {

}

function Get-InstalltionConfiguration () {

}

function Invoke-InstalltionConfiguration {
  [CmdletBinding()]
  param(
    [parameter(ValueFromPipeline)]
    [InstalltionConfiguration]
    $installConfig
  )
...
function Install ([InstalltionConfiguration]$installConfig) {}

Export-ModuleMember -Function Set-PreInstalltionSetting, Invoke-InstalltionConfiguration
